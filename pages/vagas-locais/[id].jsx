...
export default function DetalhesVagaInternacionais() {
  ...
  console.log(job ? job.length > 0 ? job : "nao é maior que zero" : "nao")
  return (
    <div className={`${robotoFlex.className} ${styles.vagaEscolhida}`}>
      <Head>
        <title>{job ? job.length > 0 ? `Vagas de Emprego no Brasil - ${job[0].tituloDaVaga}` : "Vagas de Emprego no Brasil" : "Carregando..."}</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="description" content="Encontre as melhores vagas de emprego no Brasil ou Internacional. Candidate-se hoje mesmo para oportunidades de carreira emocionantes." />
        <meta property="og:site_name" content="Home Office Vagas" />
        <meta property="og:title" content="Vagas de Emprego no Brasil - Empresas Brasileiras ou Internacionais" />
        <meta property="og:description" content="Encontre as melhores vagas de emprego no Brasil. Candidate-se hoje mesmo para oportunidades de carreira emocionantes." />
        <meta property="og:locale" content="pt_BR" />
        <meta property="og:url" content={`https://homeofficevagas.com.br/vagas-locais/${userId}`} />
        <meta property="og:type" content="website" />
        <meta name="keywords" content={job ? job.length > 0 ? `vagas de emprego, Brasil, carreira, ${job[0].tags.habilidades[0]},${job[0].tags.habilidades[1]},${job[0].tags.habilidades[2]}` : "Vagas de Emprego no Brasil" : "Carregando..."} />
