    ...
    return(
        <div className={`${robotoFlex.className} ${styles.vagaEscolhida}`}>
          <Head>
            ...
            <meta name="description" content="Encontre as melhores vagas de emprego em nosso site, somos especialistas em vagas Home Office. Candidate-se hoje mesmo para oportunidades de carreira emocionantes." />
            <meta property="og:site_name" content="Home Office Vagas" />
            <meta property="og:title" content="Vagas de Emprego é na Home Office Vagas" />
            <meta property="og:description" content="Encontre as melhores vagas de emprego em nosso site, temos varias oportunidade te esperando. Queremos fazer parte da sua carreira." />
